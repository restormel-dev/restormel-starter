  ...
  forbidden: [
    {
      ...
      severity: 'error',
      comment: 'SECURITY: Do not import server-only code (DB, Secrets) into Client Components.',
      from: { path: "^src/app/.*page\\.tsx$", pathNot: "\\.test\\.tsx$" }, // Client Pages
      to: { path: ["^src/lib/db", "^src/utils/secrets"] } // Protected Server Modules
    },
    {
      name: 'no-circular',
      severity: 'warn',
...
// generated: dependency-cruiser@17.3.7 on 2026-02-08T07:53:12.596Z
